...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    /// </summary>
    public List<Product> GetAllQuery() // Query syntax
    {
      List<Product> products = GetProducts();
      List<Product> list = new();

      // Write Query Syntax Here
      list = (from prod in products select prod).ToList(); // Casts results as List<T> from IEnumerable<T>
    ...
    /// Put all products into a collection using LINQ
    /// </summary>
    public List<Product> GetAllMethod() // Method syntax
    {
      List<Product> products = GetProducts();
      List<Product> list = new();
