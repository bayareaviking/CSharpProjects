...
#nullable restore
#line 25 "C:\Scripts\CSharpTraining\working-c-sharp-records\03\demos\ps-globomantics-csharp-records\Web\Components\EventLine.razor"
       
    private void OnSoldConfirmed(ListEventViewModel newEventViewModel)
    {
        EventViewModel = newEventViewModel;
        StateHasChanged();
    }

    [Parameter]
    public ListEventViewModel EventViewModel { get; set; }
